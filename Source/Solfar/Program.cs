    ...
    private static void ConfigureServices(IServiceCollection services)
        => services
            .AddLogging(configure => configure
                ...
                .AddFilter("RadiantPi", LogLevel.Information)
                .AddFilter("RadiantPi.Automation.AutomationController", LogLevel.Warning)
                .AddFilter("RadiantPi.Kaleidescape.KaleidescapeClient", LogLevel.Warning)
                .AddFilter("RadiantPi.Lumagen.RadianceProClient", LogLevel.Warning)
                .AddFilter("RadiantPi.Sony.Cledis.SonyCledisClient", LogLevel.Trace)
                .AddFilter("RadiantPi.Telnet", LogLevel.Information)
                .AddFilter("RadiantPi.Trinnov.Altitude.TrinnovAltitudeClient", LogLevel.Warning)
                .AddConsole()
